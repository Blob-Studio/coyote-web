...
const Effect = ({ children }: any) => {
  ...
  const composer = useMemo(() => {
    ...
    comp.addPass(new EffectPass(camera, new SMAAEffect({ preset: SMAAPreset.ULTRA })));
    comp.addPass(
      new EffectPass(
        camera,
  ...
  return (
    ...
    >
      ...
      <Suspense fallback={null}>
        ...
        <CustomPointLight color={theme.colors.primary} position={[-4, 4, 8]} intensity={12} />
        <CustomPointLight color="#4e42b9" position={[6, -8, -8]} intensity={4} />
