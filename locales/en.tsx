...
const en = {
    ...
    about: {
        content: 
            <>
                <h1>Who are we?</h1>
                <p>Coyote Web Studio is a <strong>web design</strong> and <strong>development</strong> studio. 
                We offer integral solutions for your web needs, from design to production.</p>
